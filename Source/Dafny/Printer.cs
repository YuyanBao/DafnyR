      ...
      */
      ...
      if (expr is StaticReceiverExpr) {
        ...
        */
        ...
        wr.Write("filter{");
        PrintExpr(e.RegionExpr, contextBindingStrength, fragileContext, isRightmost, false, indent);
        wr.Write(",");
        PrintType(e.T);
        wr.Write(",");
        ...
        wr.Write("fpt(");
        PrintExpr(e.E, contextBindingStrength, fragileContext, isRightmost, false, indent);
        wr.Write(")");
      } else {
