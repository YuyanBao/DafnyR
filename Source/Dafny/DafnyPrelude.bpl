...
// -- The region -------------------------------------
// ---------------------------------------------------------------
const unique rthis: Field RegionType;

axiom FDim(rthis) == 0;

// calculate the region that respects to the heap h
function RegionOfHeap(h: HeapType) : RegionType;
axiom (forall<alpha> h: HeapType, o: ref, f: Field alpha :: { RegionOfHeap(h)[o, f] } 
	RegionOfHeap(h)[o, f] <==> o != null && h[o, alloc] && h[o, rthis][o, f]);

// calculate the region that respects to the heap h and reference o
function RegionOfRef(h: HeapType, o: ref) : RegionType;
axiom (forall<alpha> h: HeapType, o: ref, f: Field alpha :: { RegionOfRef(h, o)[o, f] }
	RegionOfRef(h, o)[o, f] <==> h[o, rthis][o, f]);