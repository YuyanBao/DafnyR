...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "region": t.kind = 10; break;
			case "filter": t.kind = 11; break;
			case "ftp": t.kind = 12; break;
			case "nat": t.kind = 13; break;
			case "real": t.kind = 14; break;
			...
			case "requires": t.kind = 52; break;
			case "reveal": t.kind = 67; break;
			...
			case "in": t.kind = 136; break;
			case "fpt": t.kind = 143; break;
