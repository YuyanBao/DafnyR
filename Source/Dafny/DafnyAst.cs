...
namespace Microsoft.Dafny
{
    ...
    {
        [Pure]
        public override string TypeName(ModuleDefinition context, Boolean parseAble)
        {
            return "region";
        }
    ...
    public class RegionConstructExpression : Expression
    {
        ...
        // E may be null if it ian an empty region;
        public readonly Expression E;
        ...
        public RegionConstructExpression(IToken tok, Expression e) : base(tok)
        {
            this.E = e;
