...
namespace Microsoft.Dafny
{
    ...
    public class RegionType : BasicType
    {
        [Pure]
        public override string TypeName(ModuleDefinition context)
        {
    ...
    {
        public Type Range;
        public MapType(Type domain, Type range)
            : base(domain)
        {
    ...
    public class DefaultModuleDecl : ModuleDefinition
    {
        public DefaultModuleDecl()
            : base(Token.NoToken, "_module", false, false, null, null, true)
        {
        }
    ...
    public interface ICodeContext : ICallable
    {
        ...
        List<PatternExpression> Patterns { get; }  //Yuyan
    ...
    public class IteratorDecl : ClassDecl, ICodeContext
    {
        ...
        public readonly List<PatternExpression> Patterns; // Yuyan
        ...
        public IteratorDecl(IToken tok, string name, ModuleDefinition module, List<TypeParameter> typeArgs,
                            List<Formal> ins, List<Formal> outs, List<PatternExpression> patterns /* Yuyan */,
            ...
            : base(tok, name, module, typeArgs, new List<MemberDecl>(), attributes)
        {
            ...
            Contract.Requires(patterns != null); // Yuyan
        ...
        List<PatternExpression> ICodeContext.Patterns { get { return this.Patterns; } }    // Yuyan
    ...
    public class Function : MemberDecl, TypeParameter.ParentType, ICallable
    {
        ...
        void ObjectInvariant()
        {
            Contract.Invariant(cce.NonNullElements(TypeArgs));
            Contract.Invariant(cce.NonNullElements(Formals));
            Contract.Invariant(cce.NonNullElements(Patterns)); // Yuyan
        ...
        public Function(IToken tok, string name, bool isStatic, bool isGhost,
                        List<TypeParameter> typeArgs, IToken openParen, List<Formal> formals, List<PatternExpression> patterns /*Yuyan*/, Type resultType,
            ...
            : base(tok, name, isStatic, isGhost, attributes)
        {
            ...
            Contract.Requires(cce.NonNullElements(typeArgs));
            Contract.Requires(cce.NonNullElements(formals));
            Contract.Requires(cce.NonNullElements(patterns));   // Yuyan
    ...
    public class Predicate : Function
    {
        ...
        public Predicate(IToken tok, string name, bool isStatic, bool isGhost,
                         List<TypeParameter> typeArgs, IToken openParen, List<Formal> formals, List<PatternExpression> patterns /* Yuyan */,
                         List<Expression> req, List<FrameExpression> reads, List<Expression> ens, Specification<Expression> decreases,
                         Expression body, BodyOriginKind bodyOrigin, Attributes attributes, bool signatureOmitted)
            : base(tok, name, isStatic, isGhost, typeArgs, openParen, formals, patterns /*Yuyan*/, new BoolType(), req, reads, ens, decreases, body, attributes, signatureOmitted)
        {
    ...
    public class CoPredicate : Function
    {
        ...
        public CoPredicate(IToken tok, string name, bool isStatic,
                         ...
                         Expression body, Attributes attributes, bool signatureOmitted)
            : base(tok, name, isStatic, true, typeArgs, openParen, formals, patterns /* Yuyan */, new BoolType(),
    ...
    public class Method : MemberDecl, TypeParameter.ParentType, ICodeContext
    {
        ...
        public Method(IToken tok, string name,
                      ...
                      [Captured] List<Formal/*!*/>/*!*/ ins, [Captured] List<Formal/*!*/>/*!*/ outs, [Captured] List<PatternExpression/*!*/>/*!*/ patterns,
    ...
    public class Constructor : Method
    {
        public Constructor(IToken tok, string name,
                      [Captured] List<TypeParameter/*!*/>/*!*/ typeArgs,
                      [Captured] List<Formal/*!*/>/*!*/ ins, [Captured] List<PatternExpression/*!*/>/*!*/ patterns /* Yuyan */,
                      [Captured] List<MaybeFreeExpression/*!*/>/*!*/ req, [Captured] Specification<FrameExpression>/*!*/ mod,
                      [Captured] List<MaybeFreeExpression/*!*/>/*!*/ ens,
                      [Captured] Specification<Expression>/*!*/ decreases,
                      [Captured] BlockStmt body,
                      Attributes attributes, bool signatureOmitted)
            : base(tok, name, false, false, typeArgs, ins, new List<Formal>(), patterns/* Yuyan */, req, mod, ens, decreases, body, attributes, signatureOmitted)
        {
            Contract.Requires(tok != null);
            Contract.Requires(name != null);
            Contract.Requires(cce.NonNullElements(typeArgs));
    ...
    public class PatternExpression : Expression
    {
        ...
        public PatternExpression(IToken tok, Expression e)
            : base(tok)
        {
            Contract.Requires(e != null);
            this.E = e;
    ...
    // Yuyan: footprint expression (footprint(e))
    public class FootprintExpression : Expression
    {
        public readonly Expression E;
        private List<RegionConstructExpression> footprint;
        [ContractInvariantMethod]
        void ObjectInvariant()
        {
            Contract.Invariant(E != null);
        ...
        public FootprintExpression(IToken tok, Expression e)
            : base(tok)
        {
            this.E = e;
            footprint = new List<RegionConstructExpression>();
        }

        public List<RegionConstructExpression> Footprint
        {
            get
            {
                return footprint;
    ...
    public class BinaryExpr : Expression
    {
        ...
        public static Opcode ResolvedOp2SyntacticOp(ResolvedOpcode rop)
        {
            switch (rop)
            {
                ...
                case ResolvedOpcode.RegionEq: // Yuyan
                    return Opcode.Eq;
                ...
                case ResolvedOpcode.RegionSubRegion: // Yuyan
                    return Opcode.Lt;
                ...
                case ResolvedOpcode.RegionSubOrEqualRegion: // Yuyan
                    return Opcode.Le;
                ...
                case ResolvedOpcode.RegionDisjoint: // Yuyan
                ...
                case ResolvedOpcode.InRegion: // Yuyan
                    return Opcode.In;
                ...
                case ResolvedOpcode.SepConj: // Yuyan
    ...
    // Yuyan: 
    // if typeof(Expr) != region then Expr and Expr.* will be resovled as region{Expr} and region{Expr.*}
    // otherwise keep it (if Expr with type region )
    public class FrameExpression
    {
        ...
        public Expression ResolvedExpression;  // it will be RegionConstructExpression if typeof(E) != region
    }
    ...
    public class RegionConstructExpression : Expression
    {
        ...
        // E maybe null if it is an empty region;
        public readonly Expression E;

        public RegionConstructExpression(IToken tok, Expression e)
            : base(tok)
        {
            this.E = e;
        ...
        public List<Region> RegionList;  // filled in during resolution

        public bool canUseRThis; // filled in during resolution
        // region{this}, region{o}, region{this.f.*} can use rthis to generate regions in the translation
    ...
    public class Region
    {
        ...
        public Region(Expression obj, Field field)
        {
            Contract.Requires(obj != null);
    ...
    //Yuyan region filter expression (filter{r, K}, filter{r, K, f}, filter{r, x}, filter{r, x, f})
    public class RegionFilterExpression : Expression
    {
        ...
        public int filterType;    // filled in the resoving time
    ...
    public class ClassExpression : Expression
    {
        ...
        public ClassDecl ClsDecl;  // filled in the resolving time
    }
    ...
    // Yuyan
    public class BuiltInFunctionExpression : Expression
    {
        public readonly string FunctionName;
        public List<Expression> Args;

        public BuiltInFunctionExpression(IToken tok, List<Expression> args)
            : base(tok)
        {
            this.FunctionName = tok.val;
            this.Args = args;
        }
        ...
        private void ObjectInvariant()
        {
            Contract.Invariant(FunctionName == null && cce.NonNullElements<Expression>(Args));
        }
    }
}
